      ...
      <div class="MainAbout">
        ...
        <div class="abouttext">
          ...
          developers. This poject shows how React Js as a front-end framework can be used to make a
           show Users deatils on web pages that can run on the browser. The
          poject show how we can fetch users details with help of given User's Id with help of API. 
        </div>
      </div>
    </div>
  );
